...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="/Assets/sneat/assets/img/favicon/R.png" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="" class="app-brand-link">
              <span class="app-brand-logo demo ">
                 <img src="Assets/sneat/assets/img/backgrounds/15.png" alt="" width="110" height="40">
              </span>
            </a>
          ...
          <ul class="menu-inner py-5">
            ...
            <li class="menu-item active">
              <a href="/home" class="menu-link py-2">
            ...
            <li class="menu-item  py-2">
              <a href="index.html" class="menu-link">
                ...
                <div data-i18n="Analytics">Jelajahi</div>
              </a>
            </li>
            <li class="menu-item  py-2">
              <a href="index.html" class="menu-link">
